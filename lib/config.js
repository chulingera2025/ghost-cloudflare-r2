...
function normalizeConfig(options = {}, env = process.env) {
    ...
    return Object.freeze({
        ...
        contentPath: optionalString(options.contentPath || env.GHOST_CONTENT_PATH || env.GHOST_CONTENT),
        forcePathStyle: normalizeBoolean(options.forcePathStyle ?? env.R2_FORCE_PATH_STYLE, false),
        syncOnBoot: normalizeBoolean(options.syncOnBoot ?? env.R2_SYNC_ON_BOOT, true)
    });
}
